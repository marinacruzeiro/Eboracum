...
import eboracum.wsn.network.node.sensor.WakeUpWSNNode;
        	...
        	while (actors.hasNext()) {
                ...
                try {
                	...
                	if (bwsn.isAssignableFrom(node.getClass())){
                		...
                		/*Adicao para estatisticas do Wake-up radio*/
                		((WakeUpWSNNode)node).numberOfReceivedWakeUpMessages+";"+
                		        ((WakeUpWSNNode)node).numberOfSentWakeUpMessages+";"+
                		((WakeUpWSNNode)node).numberOfReceivedACKMessages+";"+
